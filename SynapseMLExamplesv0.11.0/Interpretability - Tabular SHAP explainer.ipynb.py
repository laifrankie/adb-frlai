...
# MAGIC %md
# MAGIC ## Interpretability - Tabular SHAP explainer
# MAGIC 
# MAGIC In this example, we use Kernel SHAP to explain a tabular classification model built from the Adults Census dataset.
# MAGIC 
...
# MAGIC %md
# MAGIC We use plotly subplot to visualize the SHAP values.
...
# MAGIC 
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/explainers/tabular-shap.png" style="float: right;"/>