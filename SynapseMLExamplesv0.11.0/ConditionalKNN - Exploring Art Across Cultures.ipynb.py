...
# MAGIC %md
# MAGIC # Exploring Art across Culture and Medium with Fast, Conditional, k-Nearest Neighbors
# MAGIC 
...
# MAGIC %md
# MAGIC ### Overview of the BallTree
...
# MAGIC %md
# MAGIC Our dataset comes from a table containing artwork information from both the Met and Rijks museums. The schema is as follows:
# MAGIC 
...
# MAGIC %md
# MAGIC #### Define categories to be queried on
...
# MAGIC %md
# MAGIC ### Define and fit ConditionalKNN models
...
# MAGIC %md
# MAGIC #### Define matching and visualizing methods
# MAGIC 
# MAGIC After the initial dataset and category setup, we prepare methods that will query and visualize the conditional kNN's results. 
# MAGIC 
...
# MAGIC %md
# MAGIC `plot_urls()` calls `plot_img` to visualize top matches for each category into a grid.
