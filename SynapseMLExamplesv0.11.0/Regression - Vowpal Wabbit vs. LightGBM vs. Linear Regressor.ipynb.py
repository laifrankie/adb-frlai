...
# MAGIC %md
# MAGIC # Vowpal Wabbit and LightGBM for a Regression Problem
# MAGIC 
# MAGIC This notebook shows how to build simple regression models by using 
# MAGIC [Vowpal Wabbit (VW)](https://github.com/VowpalWabbit/vowpal_wabbit) and 
# MAGIC [LightGBM](https://github.com/microsoft/LightGBM) with SynapseML.
# MAGIC  We also compare the results with 
# MAGIC  [Spark MLlib Linear Regression](https://spark.apache.org/docs/latest/ml-classification-regression.html#linear-regression).
...
# MAGIC %md
# MAGIC Following is the summary of the training set.
...
# MAGIC %md
# MAGIC Plot feature distributions over different target values (house prices in our case).
...
# MAGIC %md
# MAGIC ## Baseline - Spark MLlib Linear Regressor
# MAGIC 
# MAGIC First, we set a baseline performance by using Linear Regressor in Spark MLlib.
...
# MAGIC %md
# MAGIC Perform VW-style feature hashing. Many types (numbers, string, bool, map of string to (number, string)) are supported.
...
# MAGIC %md
# MAGIC Following figure shows the actual-vs.-prediction graphs of the results:
# MAGIC 
# MAGIC <img width="1102" alt="lr-vw-lg" src="https://mmlspark.blob.core.windows.net/graphics/Documentation/regression_comparison.png" />
