...
# MAGIC %md
# MAGIC ## Automated Snow Leopard Detection with Synapse Machine Learning
# MAGIC 
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/SLTrust.PNG" width="900" style="float: left;"/>
...
# MAGIC %md
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SparkSummit2/cog_services.png" width="900" style="float: left;"/>
...
# MAGIC %md
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/SLPipeline.PNG" width="900" style="float: left;"/>
...
# MAGIC <img src="https://mmlspark.blob.core.windows.net/graphics/SnowLeopardAD/lime_results.png" width="900" style="float: left;"/>